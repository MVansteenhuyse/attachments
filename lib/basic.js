...
module.exports = class AttachmentsService extends cds.Service {
  ...
  registerUpdateHandlers(srv, entity, target) {
    srv.before("PUT", target, (req) => {
      console.log('before PUT non-draft attachment');
      console.log(req);
    });
    srv.on("PUT", target, async (req) => {
      console.log('on PUT non-draft attachment');
      console.log(req);
    });
    srv.after("PUT", target, async (req) => {
      console.log('after PUT non-draft attachment');
      console.log(req);
